 ...
 * <p>
 * En mode multijoueur, chaque joueur joue sur sa propre carte : l'état
 * « visitée » d'une balise est donc propre au joueur (ses balises capturées),
 * et non porté par la balise partagée.
 *
 * @author Groupe 2
 * @version 1.0
 */
