 ...
 * <p>
 * En mode multijoueur, l'état « visitée » n'est plus porté par la balise (qui
 * est partagée par tous les joueurs) mais par chaque {@link Joueur} : une balise
 * est visitée par un joueur si elle figure parmi ses balises capturées.
 *
 * @author Groupe 2
 * @version 1.0
 */
