...
public class Joueur
{
	...
	/**
	 * Modifie la balise de départ actuel avec la baliseDepart mis en paramètre
	 */
	...
	/**
	 * Indique si la balise a été visitée
	 * @return {@code true} si la balise a été visité durant la manche
	 */
	...
	/**
	 * Indique si les 2 chemins de 2 manches différentes différentes se croisent ou non
	 * @return {@code true} si les chemins se croisent
	 */
