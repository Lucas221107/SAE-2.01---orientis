...
public class PanelBalise extends JPanel implements ActionListener
{
	...
	public PanelBalise(FramePrincipale frame , PanelPlateau panelPlateau , Controleur ctrl)
	{
		...
		this.panelImageBalise.setOpaque(false);
		...
		JLabel lblInfo = new JLabel( "Glisser Déposer vos balises sur le plateau");
	...
	public void actionPerformed ( ActionEvent e)
	{
		...
		{ 
			this.panelPlateau.setModeGomme(true);
	...
	private class GereSouris extends MouseAdapter
	{
		...
		public void mouseReleased(MouseEvent e)
		{
			...
			int cptCol = ( p.x - PanelBalise.this.panelPlateau.getDecalageX()) / TAILLE_CASE; 
			int cptLig = ( p.y - PanelBalise.this.panelPlateau.getDecalageY()) / TAILLE_CASE;
	...
	private void genererBalise()
	{
		...
		for ( int cpt = 0; cpt < this.nbBalise; cpt ++)
		{
			...
			ImageIcon icon = new ImageIcon("../conception/ihm/images/balise_" + numBalise + ".png");
			icon           = new ImageIcon(icon.getImage().getScaledInstance(this.TAILLE_CASE, this.TAILLE_CASE, Image.SCALE_SMOOTH));
