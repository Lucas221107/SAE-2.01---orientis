...
public class PanelSelectionBiome extends JPanel implements ActionListener
{
	...
	public PanelSelectionBiome ( FramePrincipale frame, PanelPlateau panelPlateau, Controleur ctrl )
	{
        ...
        int       largeur     = (int) ( tailleEcran.getWidth() * 0.375 ); //0,5 * 0,75
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		{
			this.framePrincipale.switchPanel("balise");
			...
			{				
				...
				{
					Color coul = this.panelPlateau.getCaseColor ( lig, col );

					if ( coul != null)
						tabNomBiome[lig][col] = this.ctrl.toColor ( coul ).getNom();
					else
						tabNomBiome[lig][col] = "Forêt Claire";					
				}
			}

			this.ctrl.setTabStringBiome ( tabNomBiome );
