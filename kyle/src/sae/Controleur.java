...
public class Controleur 
{
	...
	public TypeBiome toColor ( Color c )
	{
		return TypeBiome.toColors( c );
	}


	public void setTabNumBalise ( int[][] tab)
	{
		this.plateau.setTabNumBalise ( tab );
	}


	public void setTabStringBiome ( String[][] tab)
	{
		this.plateau.setTabStringBiome(tab);
	}
